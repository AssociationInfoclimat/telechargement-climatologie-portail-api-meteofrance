import { InMemoryHoraireRepository } from '@/produits-obs/station/horaire/db/adapters/HoraireRepository.in-memory.js';
import { HoraireLineDTO } from '@/produits-obs/station/horaire/HoraireLineDTO.js';
import { describe, expect, it } from 'vitest';

describe('InMemoryHoraireRepository', () => {
    describe('upsertMany', () => {
        it('should upsert horaire data', async () => {
            ...
            const repository = new InMemoryHoraireRepository();
