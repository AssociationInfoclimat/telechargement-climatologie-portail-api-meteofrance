...
} from '@/produits-obs/station/horaire/api/adapters/fetchHoraireData.in-memory.js';
...
describe('HoraireDataFetcher', () => {
    describe('when too many retries', () => {
        it('should throw too many retries error', async () => {
            ...
            await expect(() =>
                fetcher.fetchHoraireData({
                    idStation: IdStation.of('76116001'),
                    horaireDate: createHoraireDate({ year: 2024, month: 10, day: 16, hour: 12 }),
                })
