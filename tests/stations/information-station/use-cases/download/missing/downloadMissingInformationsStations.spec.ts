...
describe('downloadMissingInformationsStations', () => {
    it('should download missing stations informations', async () => {
        ...
        const informationsStationsRepository = InMemoryInformationsStationsRepository.of([rouenInformationsDTO]);
        await downloadMissingInformationsStations({
            stationsRepository: InMemoryStationsRepository.withInformationsRepository([rouenDTO, bouellesDTO], {
