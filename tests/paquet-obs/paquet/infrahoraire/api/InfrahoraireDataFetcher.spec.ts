...
} from '@/paquet-obs/paquet/infrahoraire/api/adapters/fetchInfrahoraireData.in-memory.js';
...
describe('InfrahoraireDataFetcher', () => {
    describe('when too many retries', () => {
        it('should throw too many retries error', async () => {
            ...
            await expect(() => fetcher.fetchInfrahoraireData(IdStation.of('76116001'))).rejects.toThrow(
                TooManyRetriesError
            );
        });
    });
    ...
    describe('when successful', () => {
        it('should return the data', async () => {
            ...
            const fetched = await fetcher.fetchInfrahoraireData(IdStation.of('76116001'));
